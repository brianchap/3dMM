...
def transform_test(vertices, obj, camera, fblood, fmel, h = 256, w = 256):
	...
	nm_wavelength = [400, 410, 420, 430, 440, 450, 460, 470, 480, 490, 500, 510, 520, 530, 540, 550, 560, 570, 580, 590, 600, 610, 620, 630, 640, 650, 660, 670, 680, 690, 700, 710, 720]
	temperature = 6000
	spd = source_distr(nm_wavelength, temperature)
	wavelength2 = sum(multer(spd, nm_wavelength))
	...
	strength_val, angles, normals = compute_strength(wavelength, fblood, fmel, image_vertices, triangles, source, derm_depth, epi_depth)
	brdf_val = []
...
# save folder
save_folder = 'results/intensity_distro4'
